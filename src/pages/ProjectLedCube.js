...
export default function ProjectLedCube() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 style={{ color: "#61dafb", marginTop: 20 }}>LED Cube</h1>
        <p style={{ maxWidth: 800, textAlign: "center", marginTop: 20 }}>
          Details about the LED Cube project go here. Add description, media, and links as needed.
        </p>
      </div>
    </div>
  );
